      ...
      <div className="relative z-10 w-full max-w-md lg:flex-1 lg:max-w-lg flex items-center justify-center px-6 sm:px-12 lg:px-12 pt-24 pb-12">
        <div className="w-full max-w-sm anim-reveal" style={{ animationDelay: '0.2s' }}>
          ...
          <div className="relative surface-metal-brushed metal-scratches rounded-2xl p-6 sm:p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                >
                  <span className="pl-3 text-ink-3" style={{ color: focused === 'college' ? 'var(--mint)' : undefined }}>
                    <Building2 size={14} />
                  </span>
                  <select
            ...
            <div className="mt-6 flex items-center gap-3">
              ...
              <span className="font-technical text-[8px] text-ink-3">ALREADY IN?</span>
              <div className="flex-1 h-px bg-metal-2/40" />
            </div>
          ...
          <div className="mt-4 flex items-center justify-center gap-2">
            <span className="font-technical text-[7px] text-ink-3">CAMPUSJUGAAD EXCHANGE · STUDENT ROLE ASSIGNED AUTOMATICALLY</span>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div>
      <div className="flex items-center gap-2 mb-2">
        ...
        <span
          className="font-technical text-[8px] transition-colors duration-300"
          style={{ color: active ? 'var(--mint-soft)' : 'var(--text-3)' }}
        >
          {label} {active && '· ACTIVE'}
        </span>
      </div>
      ...
      >
        <span className="pl-3 text-ink-3" style={{ color: active ? 'var(--mint)' : undefined }}>
          {icon}
        </span>
        <input
          type={type}
